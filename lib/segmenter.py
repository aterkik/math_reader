...
class SegmenterFeatures(object):
    ...
    def shape_context_features(strk_pair, strk_grps):
        ...
        # # TODO: not using global features for now. They're slow and give only around 5%
        # F-Measure boost
        # global_all_coords = tuple([strk.coords.T for strk in strk_grps])
    ...
    def _geometric_features(strk_pair, strk_grps):
        ...
        # return [average_distance(stroke1,stroke2), parallelity(stroke1,stroke2),
        # min_distance(stroke1,stroke2)]
